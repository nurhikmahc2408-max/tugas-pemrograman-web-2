<x-app>
    ...
    <form method="POST" action="{{ route('Absen.update', $absen) }}">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal"
                name="tanggal" value="{{ old('tanggal', $absen->tanggal) }}">
        ...
        <div class="mb-3">
            ...
            <input type="time" class="form-control @error('jam_masuk') is-invalid @enderror" id="jam_masuk"
                name="jam_masuk" value="{{ old('jam_masuk', $absen->jam_masuk) }}">
        ...
        <div class="mb-3">
            ...
            <input type="time" class="form-control @error('jam_keluar') is-invalid @enderror" id="jam_keluar"
                name="jam_keluar" value="{{ old('jam_keluar', $absen->jam_keluar) }}">
        ...
        <div class="mb-3">
            ...
            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status">
                ...
                <option value="Alfa" {{ old('status', $absen->status) == 'Alfa' ? 'selected' : '' }}>Alfa</option>
            </select>
